      ...
      <section className="overflow-x-hidden">
        <div className="flex-col flex items-center justify-center px-5 md:px-10">
          <div className="flex-col flex min-w-[100vw] items-center justify-end bg-black py-6 max-[479px]:px-5 h-auto md:h-64">
            <div className="flex-col flex items-center gap-y-4 py-5">
              <h1 className="font-bold text-3xl md:text-5xl text-[#FF9500]">
                TERMS OF SERVICE
              </h1>
              <p className="flex-col text-[#808080] text-sm sm:text-base">
                Last Updated as of October 17, 2024
              </p>
            </div>
          </div>
          <div className="py-12 md:py-16 lg:py-20 mx-auto w-full max-w-5xl">
            <div className="flex-col flex items-center gap-y-[60px]">
              <div className="max-w-[780px]">
                <p className="text-center max-[479px]:text-sm">
              ...
              <div className="flex-col flex min-w-full items-start gap-y-10">
                <div className="flex-col flex min-w-full items-start [border-bottom:1px_solid_rgb(226,_226,_226)] py-4">
                ...
                <div className="flex-col flex items-start gap-y-10 sm:gap-y-[46px]">
                  <div className="flex-col flex min-w-full items-start gap-y-6">
                    <div className="flex-col flex items-start gap-y-3">
                      <p className="font-bold text-sm sm:text-sm">SERVICES</p>
                    ...
                    <div className="flex-col flex items-start gap-y-3">
                      <p className="font-bold text-sm sm:text-sm">PAYMENT</p>
                      <p className="text-sm sm:text-sm">
